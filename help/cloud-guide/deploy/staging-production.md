...
1. Voltooi al [&#x200B; het testen &#x200B;](../test/staging-and-production.md) in het milieu van het Staging.
1. Wanneer het Staging klaar is, selecteer de **1&rbrace; optie van de Fusie &lbrace;om aan Productie (**) op te stellen.`master`
...
Zie [&#x200B; hulp 0&rbrace; opnieuw synchroniseren.](https://linux.die.net/man/1/rsync)
