...
Om uw montages van de e-maillevering beter te beheren, gebruik uw eigen [&#x200B; server SMTP of dienstverlener van de e-maillevering &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/communications/email-communications). U kunt zich ook aanmelden voor uw eigen SendGrid-service om de Cloud-servicestapel op de voet te volgen.

>
>
>Als u uw eigen SendGrid-account gebruikt, ontvangt u geen SendGrid-ondersteuning meer via Adobe.
>
> Om uw merkgebonden dienst SendGrid toe te laten of een bestaande API Sleutel bij te werken, [&#x200B; een kaartje van de Steun van Adobe Commerce &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket) voorleggen en API Sleutel voor uw rekening omvatten SendGrid.
...
>[!WARNING]
>
>De handtekeningen van SendGrid DKIM en de steun van de domeinauthentificatie zijn beschikbaar slechts op de Productie en het Staging milieu&#39;s voor Pro projecten. Ze worden niet ondersteund in Starter-omgevingen.
>
>Daarom zijn transactionele e-mails die vanuit Starter-omgevingen worden verzonden, waarschijnlijker gemarkeerd als spam omdat ze niet volledig kunnen worden geverifieerd.  In Pro-omgevingen wordt uw verzendende domein geverifieerd door DKIM in te schakelen. Hierdoor wordt de e-mailleverbaarheid aanzienlijk verbeterd en de kans dat berichten als spam worden gefilterd, verminderd.
>
>Om het tarief van de berichtlevering te verbeteren, bevorder van Aanzet aan Pro, of gebruik uw eigen server SMTP of dienstverlener van de e-maillevering. Zie [&#x200B; E-mailverbindingen &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/communications/email-communications) in de _gids van Systemen Admin_ vormen.
...
>[!NOTE]
>
>Het `var/log/mail.log` dossier is a *lopende logboek*. Wanneer nieuwe items worden toegevoegd, worden oudere items uit het bestand verwijderd. Alleen de meest recente logboekactiviteit is beschikbaar in het logbestand. De oudere logboekingangen worden niet gearchiveerd of behouden zodra verwijderd uit mail.log.
