...
1. Klik op **[!UICONTROL Administration]** en selecteer een van de volgende opties in de lijst:
   ...
   - **[!UICONTROL User management]** om gebruikers toe te voegen, actieve gebruikers en uitnodigingen in behandeling te beheren, en gebruikers te verwijderen of te deactiveren die geen toegang meer nodig hebben, bijvoorbeeld gebruikers die uw bedrijf hebben verlaten.
...
Voor meer details, zie het [&#x200B; de dienstoverzicht van New Relic &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/monitor/new-relic/new-relic-service).
