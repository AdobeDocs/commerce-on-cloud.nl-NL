...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **PHP 8.5** - Toegevoegde steun voor PHP 8.5.<!-- MCLOUD-14179 -->
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Bijgewerkte Functionele Test** - Bijgewerkte Valkey 8.1, 8.2 en Redis 8.4 tests <!-- MCLOUD-13983 -->
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Bijgewerkt MariaDB, PHP en Validators van het Opensonderzoek** - Bijgewerkt het validatormanuscript.<!-- MCLOUD-14574/MCLOUD-14466 -->
- ![&#128279;](../../assets/fix.svg) **EOL validator** - Bijgewerkt Eind van het Leven (EOL) de dienstendata van de fixepictogram .<!-- MCLOUD-14272 -->
...
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Vaste geheim voorgeheugenschoonmaakbeurt voor de actieve diensten** - Toegevoegde actieve de dienstbevestiging.<!-- MCLOUD-14166 -->

## v2002.2.8

Releasedatum: 8 oktober 2025

- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **ActiveMQ** - Toegevoegde steun voor ActiveMQ.<!-- MCLOUD-13770 -->
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **ActiveMQ** - Toegevoegde functionele tests.<!-- MCLOUD-13813 -->
...
-  **Valkey validator** - Vaste het pictogram van de moeilijke situatie &lbrace;<!-- MCLOUD-13896 -->.![&#128279;](../../assets/fix.svg)
- **de hulpmiddelen** - Toegevoegde de testverbeteringen van de Eenheid van 0&rbrace; fixpictogram &lbrace;<!-- MCLOUD-13838 -->.![&#128279;](../../assets/fix.svg)
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **tests Openssearch3** - Toegevoegde functionele tests.<!-- MCLOUD-13769 -->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **Uitgebreide Valkey verenigbaarheid** - Uitgebreide Valkey verenigbaarheid in Adobe Commerce.<!-- MCLOUD-13595 -->
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Bijgewerkte validator RabbitMQ** - Bijgewerkte validator voor RabbitMQ.<!-- MCLOUD-13589 -->
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Bijgewerkte validator MariaDB** - Bijgewerkte knoop-hulpmiddelen validator voor MariaDB 10.11.<!-- MCLOUD-13593 -->
- &rbrack;(../../assets/fix.svg) **Uitgebreide Openssearch2 verenigbaarheid** - Gemaakt Openssearch2 compatibel met de recentste 2.4.4 versies.<!-- MCLOUD-13710 -->!&lbrack;

## v2002.2.4

Releasedatum: 24 april 2025

- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Openssearch2 voor 2.4.4/2.4.5** - Vaste een kwestie met betrekking tot steun voor `opensearch2` in de versies van Adobe Commerce 2.4.4/2.4.5. <!-- MCLOUD-13607 -->

## v2002.2.3

Releasedatum: 9 april 2025

- ![&#128279;](../../assets/fix.svg) **Repareer Valkey** Vaste kwestie met geldige douaneconfiguratie  fixpictogram &lbrace;. <!-- MCLOUD-13569 -->
...
- ![&#x200B; herstellingspictogram &#x200B;](../../assets/fix.svg) **Geheime voorgeheugen :flush registreren** - verbeterde logboekingangen om op het begin en de beëindiging van de `cache:flush` stap te wijzen.<!--MCLOUD-7503-->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **de verbeteringen van de Bevestiging** -
   ...
   - ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **bijgewerkte de dienstversie en de bevestigingscontroles van EOL** - bijgewerkte bevestiging om geïnstalleerde de dienstversies tegen Adobe Commerce 2.4 te controleren. vereisten.<!--MCLOUD-6144-->
