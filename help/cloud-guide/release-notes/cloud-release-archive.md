...
- ![ herstellingspictogram ](../../assets/fix.svg) **Patches en kritieke moeilijke situaties** - werk uw milieu&#39;s van de Wolk met `ece-tools` versie 2002.0.22 bij om de volgende flarden en kritieke moeilijke situaties toe te passen. Deze patches worden opgenomen in het pakket `magento/magento-cloud-patches` v1.0.0.
   ...
   - ![ ](../../assets/fix.svg) de paginering van de Catalogus van 0} bevestigt pictogram **werkt niet op Elasticsearch 6.x {een kritieke kwestie met de paginering van het onderzoeksresultaat die klanten gebruikend Elasticsearch 6.x als motor van het catalogusonderzoek beïnvloedt.**<!--MAGECLOUD-4448-->
...
- ![ nieuw pictogram ](../../assets/new.svg) **Samenstellen van het Dock voor Wolk** - toegevoegd een bevel - `docker:build` - om a [ Docker te produceren stelt ](https://developer.adobe.com/commerce/cloud-tools/docker/configure/) configuratie van de 7} bewaarplaats van de Wolk samen.`ece-tools`<!-- MAGECLOUD-2250 -->
