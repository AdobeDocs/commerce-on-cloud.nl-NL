...
- ![&#x200B; herstellingspictogram &#x200B;](../../assets/fix.svg) **Patches en kritieke moeilijke situaties** - werk uw milieu&#39;s van de Wolk met `ece-tools` versie 2002.0.22 bij om de volgende flarden en kritieke moeilijke situaties toe te passen. Deze patches worden opgenomen in het pakket `magento/magento-cloud-patches` v1.0.0.
   ...
   - ![&#x200B; &#x200B;](../../assets/fix.svg) de flarden MSI van 0&rbrace; fixepictogram **- moeilijke situaties die indexerende fouten en prestatieskwesties veroorzaakten wanneer het gebruiken van standaardinventarismontages voor het beheren van voorraad.**<!--MAGECLOUD-4428-->
   ...
   - ![&#x200B; &#x200B;](../../assets/fix.svg) de paginering van de Catalogus van 0&rbrace; bevestigt pictogram **werkt niet op Elasticsearch 6.x &lbrace;een kritieke kwestie met de paginering van het onderzoeksresultaat die klanten gebruikend Elasticsearch 6.x als motor van het catalogusonderzoek beïnvloedt.**<!--MAGECLOUD-4448-->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **de Updates van de Docker** -
   ...
   - ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) voegde `analysis-icu` en de `analysis-phonetic` stop van Elasticsearch aan alle beelden van de Dokker toe.<!-- MAGECLOUD-3446 -->
...
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) verbeterde de fout-verdraagzame montages van het pakket van Magento Open Source. Als Adobe Commerce geen gegevens kan lezen van de instantie Redis `slave` , wordt een waarde gelezen van de instantie Redis `master` . Zie [&#x200B; REDIS_USE_SLAVE_CONNECTION &#x200B;](../environment/variables-deploy.md#redis_use_slave_connection).<!-- MAGECLOUD-2899 -->

## v2002.0.17

>[!NOTE]
>
>De `ece-tools` versie 2002.0.17 bevat een belangrijke beveiligingspatch. Zie [&#x200B; de Middelen van de Tech: De Patches van Magento Open Source &#x200B;](https://magento.com/tech-resources/download#download2288).
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **de updates van de Dokker** -
   ...
   - Toegevoegd de capaciteit om [&#x200B; Xdebug &#x200B;](https://developer.adobe.com/commerce/cloud-tools/docker/configure-xdebug) te vormen om in het milieu van het Dok van de Wolk te zuiveren.<!-- MAGECLOUD-2891 -->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **Nieuwe milieu variabele** - door gebrek, slechts heeft het milieu van de Productie toegelaten Google Analytics. U kunt Google Analytics op de het Opvoeren en milieu&#39;s van de Integratie toelaten gebruikend [&#x200B; ENABLE_GOOGLE_ANALYTICS omgevingsvariabele &#x200B;](../environment/variables-deploy.md#enable_google_analytics).<!--MAGECLOUD-2879-->
...
- ![&#x200B; &#x200B;](../../assets/fix.svg) moeilijke situaties van de Plaatsing 0&rbrace; fixpictogram **-**
   ...
   - De Elasticsearch-versie op de cloudinfrastructuur is niet compatibel met de versie van de elasticsearch/elasticsearch module die door Adobe Commerce wordt ondersteund op de cloudinfrastructuur. Zie het [&#x200B; het oplossen van problemenartikel van Elasticsearch &#x200B;](https://support.magento.com/hc/en-us/articles/360015758471-Deployment-fails-or-interrupts-with-cloud-log-error-Elasticsearch-version-is-not-compatible-with-current-version-of-magento) in de Kennisbank van de Steun van Adobe Commerce.<!--MAGECLOUD-2600-->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **Samenstellen van de Teller voor wolk** - maakte de volgende verbeteringen in de [&#x200B; opstelling en de configuratieproces van de Dokker &#x200B;](https://developer.adobe.com/commerce/cloud-tools/docker/configure/):
   ...
   - Nu hebt u het vermogen van de stortplaats van DB wanneer het gebruiken van de Dok van de Wolk [&#x200B; gegevensbestandcontainer &#x200B;](https://developer.adobe.com/commerce/cloud-tools/docker/containers/service#database-container). Ook, kunt u dossiers [&#x200B; tussen een gastheermachine en een container delen gebruikend de &#x200B;](https://developer.adobe.com/commerce/cloud-tools/docker/containers#sharing-data-between-host-machine-and-container) folder.`docker/mnt`<!-- MAGECLOUD-2577 -->
...
- ![&#x200B; &#x200B;](../../assets/fix.svg) de configuratiecontroles van het Milieu 1&rbrace; **bevestigen pictogram** - Verbeterde bevestiging van de milieuconfiguratie om klanten over versionverenigbaarheden en configuratiefouten te waarschuwen alvorens Adobe Commerce op wolkeninfrastructuur te bouwen en op te stellen.
   ...
   - Er is een Elasticsearch-compatibiliteitscontrole toegevoegd om gebruikers te waarschuwen voor Elasticsearch-configuratieproblemen. De implementatie mislukt nu als de versie van de Elasticsearch-service op de server niet compatibel is met Adobe Commerce. Eerder, slaagde de plaatsing zelfs als de versie van Elasticsearch incompatibel was, die de kwesties van de productcatalogus na plaatsplaatsing veroorzaakte.<!--MAGECLOUD-2389-->

     U kunt de onverenigbaarheid oplossen door een kaartje van de Steun [&#x200B; voor te leggen om Elasticsearch aan een compatibele versie te bevorderen, of de configuratie van Adobe Commerce te veranderen om een compatibele versie van de cliënt van Elasticsearch te specificeren PHP.](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/deploy/best-practices)

      - Voor Adobe Commerce versie 2.1.x naar 2.2.2, upgrade Elasticsearch naar versie 2.4.

      - Voer voor Adobe Commerce versie 2.2.3 en hoger een upgrade uit naar Elasticsearch versie 5.2.

      - Als u Elasticsearch 1.x of 2.x hebt en geen upgrade wilt uitvoeren, moet u de Adobe Commerce Elasticsearch PHP client version-vereiste in composer.json bijwerken naar `"elasticsearch/elasticsearch": "~2.0"` .
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **Samenstellen van het Dock voor Wolk** - toegevoegd een bevel - `docker:build` - om a [&#x200B; Docker te produceren stelt &#x200B;](https://developer.adobe.com/commerce/cloud-tools/docker/configure/) configuratie van de 7&rbrace; bewaarplaats van de Wolk samen.`ece-tools`<!-- MAGECLOUD-2250 -->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) voegde de volgende [**variabelen van het Milieu**](../environment/variables-intro.md) toe:
   ...
   - De nieuwe {[&#x200B; variabele 0} MIN_LOGGING_LEVEL treedt het minimumregistrerenniveau voor alle outputstromen met voeten zonder veranderingen in de code aan te brengen.](../environment/variables-global.md#min_logging_level)<!-- MAGECLOUD-2129 -->
...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) voegde de volgende [**variabelen van het Milieu**](../environment/variables-intro.md) toe:
   ...
   - `SKIP_HTML_MINIFICATION` - _Globale_ milieuvariabele die het kopiëren van de statische meningsdossiers in de `var/view_preprocessed` folder overslaat en geminificeerde HTML wanneer gevraagd produceert.<!-- MAGECLOUD-1621 and MAGECLOUD-1736-->
...
- **bouwt/stelt berichten** op - wij hebben een configuratiedossier toegevoegd dat u aan [&#x200B; opstelling Slack en/of e-mailberichten &#x200B;](../environment/set-up-notifications.md) voor bouwstijl kunt gebruiken/acties in al uw milieu&#39;s opstelt.
...
- We hebben een probleem verholpen dat fouten veroorzaakte bij het laden van de opslagruimte nadat we HTML-miniaturen hadden ingeschakeld in Admin.<!-- MAGECLOUD-1138 -->
