...
- ![&#x200B; nieuw pictogram &#x200B;](../../assets/new.svg) **PHP 8.5** - Toegevoegde steun voor PHP 8.5.<!-- MCLOUD-14181 -->
- ![&#x200B; herstellingspictogram &#x200B;](../../assets/fix.svg) **Bijgewerkte functionele tests voor PHP 8.x** - Verwijderde erfenis PHP 7.x tests, toegevoegde PHP 8.1 en 8.2 nieuwe testdekking en bijgewerkte versies van Adobe Commerce.<!-- MCLOUD-14203 -->
...
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Reparatie** - verbeter voor de [&#x200B; Controle ontbreekt wanneer JS minificatie en het bundelen &#x200B;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) kwestie &lbrace;die in *wordt beschreven de Knowledgebase van Commerce* wordt toegelaten.
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Verbeterde Mening van de Categorie** - MCLOUD-13752: Verbeter categoriemening.<!-- MCLOUD-13752 | MCLOUD-14139  -->
...
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Verbeterde Mening van de Categorie** - verbeter categoriemening.<!-- MCLOUD-13752	 - -->
