...
- ![ fixpictogram ](../../assets/fix.svg) **Reparatie** - verbeter voor de [ Controle ontbreekt wanneer JS minificatie en het bundelen ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) kwestie {die in *wordt beschreven de Knowledgebase van Commerce* wordt toegelaten.
