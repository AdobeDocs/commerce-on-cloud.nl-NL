...
- ![&#x200B; fixpictogram &#x200B;](../../assets/fix.svg) **Reparatie** - vergelijk voor de [&#x200B; Controle ontbreekt wanneer JS minification en het bundelen &#x200B;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)) kwestie die in *Commerce Knowledgebase wordt beschreven (kaartjes AC-15867 &amp; ACSD-68617).<!-- MCLOUD-14191 -->
