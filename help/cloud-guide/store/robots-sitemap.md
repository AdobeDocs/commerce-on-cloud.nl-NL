...
Als u `robots.txt` -aanpassingen in productie wilt activeren, schakelt u indexering door zoekprogramma&#39;s in voor de optie `<environment-name>` in de projectinstellingen in de cloud-console:

- Verouderde cloudconsole - de URL volgt het patroon `https://<region-id>.magento.cloud/projects/<project_id>`

  Wissel het plaatsen [!UICONTROL Indexing by search engines] (Verouderde Console) [!UICONTROL Hide from search engines] (de Console van Adobe) aan **aan**.

  ![ Gebruik [!DNL Cloud Console] om milieu&#39;s ](../../assets/robots-indexing-by-search-engine.png) te beheren

- Adobe Cloud Console - de URL volgt het patroon ``https://console.adobecommerce.com/<username>/<project_id>``

  Schakel de instelling [!UICONTROL Hide from search engines] uit.
