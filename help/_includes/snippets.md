...
>
>
>Als uw veranderingen niet op het Opvoeren van plaatsen na herplaatsing en geen verwante foutenmeldingen in het logboek worden weerspiegeld, moet u **[&#x200B; een kaartje van de Steun van Adobe Commerce voorleggen &#x200B;](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html#submit-ticket).** In het kaartje, beschrijf duidelijk de configuratieveranderingen u probeerde en om het even welke bijgewerkte configuratiedossiers YAML in het kaartje vastmaakt.
